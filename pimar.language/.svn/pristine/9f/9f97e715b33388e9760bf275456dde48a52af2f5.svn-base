 ...
 * <ul>
 *   <li>{@link wcoreDatabase.impl.BinaryExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link wcoreDatabase.impl.BinaryExpressionImpl#getLeftExpressions <em>Left Expressions</em>}</li>
 *   <li>{@link wcoreDatabase.impl.BinaryExpressionImpl#getRightExpression <em>Right Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BinaryExpressionImpl extends ExpressionImpl implements BinaryExpression {
	...
	protected EClass eStaticClass() {
		return WcoreDatabasePackage.Literals.BINARY_EXPRESSION;
	}
	...
	public void setOperator(BinaryOperators newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.BINARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain basicSetLeftExpressions(Expression newLeftExpressions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.BINARY_EXPRESSION__LEFT_EXPRESSIONS, oldLeftExpressions, newLeftExpressions);
	...
	public void setLeftExpressions(Expression newLeftExpressions) {
		if (newLeftExpressions != leftExpressions) {
			...
			if (leftExpressions != null)
				msgs = ((InternalEObject)leftExpressions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.BINARY_EXPRESSION__LEFT_EXPRESSIONS, null, msgs);
			if (newLeftExpressions != null)
				msgs = ((InternalEObject)newLeftExpressions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.BINARY_EXPRESSION__LEFT_EXPRESSIONS, null, msgs);
			msgs = basicSetLeftExpressions(newLeftExpressions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.BINARY_EXPRESSION__LEFT_EXPRESSIONS, newLeftExpressions, newLeftExpressions));
	}
	...
	public NotificationChain basicSetRightExpression(Expression newRightExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.BINARY_EXPRESSION__RIGHT_EXPRESSION, oldRightExpression, newRightExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRightExpression(Expression newRightExpression) {
		if (newRightExpression != rightExpression) {
			...
			if (rightExpression != null)
				msgs = ((InternalEObject)rightExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.BINARY_EXPRESSION__RIGHT_EXPRESSION, null, msgs);
			if (newRightExpression != null)
				msgs = ((InternalEObject)newRightExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.BINARY_EXPRESSION__RIGHT_EXPRESSION, null, msgs);
			msgs = basicSetRightExpression(newRightExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.BINARY_EXPRESSION__RIGHT_EXPRESSION, newRightExpression, newRightExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WcoreDatabasePackage.BINARY_EXPRESSION__LEFT_EXPRESSIONS:
				return basicSetLeftExpressions(null, msgs);
			case WcoreDatabasePackage.BINARY_EXPRESSION__RIGHT_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcoreDatabasePackage.BINARY_EXPRESSION__OPERATOR:
				return getOperator();
			case WcoreDatabasePackage.BINARY_EXPRESSION__LEFT_EXPRESSIONS:
