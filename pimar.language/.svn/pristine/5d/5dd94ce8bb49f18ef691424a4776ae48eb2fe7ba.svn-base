 ...
 * <ul>
 *   <li>{@link wcoreDatabase.IfElse#getElseBody <em>Else Body</em>}</li>
 * </ul>
 * </p>
 *
 * @see wcoreDatabase.WcoreDatabasePackage#getIfElse()
 * @model
 * @generated
 */
public interface IfElse extends If {
	 ...
	 * @see #setElseBody(Task)
	 * @see wcoreDatabase.WcoreDatabasePackage#getIfElse_ElseBody()
	...
	/**
	 * Sets the value of the '{@link wcoreDatabase.IfElse#getElseBody <em>Else Body</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
