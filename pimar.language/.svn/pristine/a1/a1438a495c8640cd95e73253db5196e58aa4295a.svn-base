 ...
 * <ul>
 *   <li>{@link wcore.impl.PermissionImpl#getPermission <em>Permission</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PermissionImpl extends ENamedElementImpl implements Permission {
	/**
	 ...
	 * @ordered
	 */
	protected static final Permissions PERMISSION_EDEFAULT = Permissions.INTERNET;
	...
	protected EClass eStaticClass() {
		return WcorePackage.Literals.PERMISSION;
	}
	...
	public void setPermission(Permissions newPermission) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.PERMISSION__PERMISSION, oldPermission, permission));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcorePackage.PERMISSION__PERMISSION:
