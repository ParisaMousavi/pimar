 ...
 * <ul>
 *   <li>{@link wcore.impl.CreateImpl#getEClass <em>EClass</em>}</li>
 *   <li>{@link wcore.impl.CreateImpl#getReturn <em>Return</em>}</li>
 *   <li>{@link wcore.impl.CreateImpl#getAnchor <em>Anchor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CreateImpl extends TaskImpl implements Create {
	...
	protected EClass eStaticClass() {
		return WcorePackage.Literals.CREATE;
	}
		...
		if (eClass != null && eClass.eIsProxy()) {
			...
			if (eClass != oldEClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.CREATE__ECLASS, oldEClass, eClass));
			}
		}
		return eClass;
	}
	...
	public void setEClass(EClass newEClass) {
		...
		eClass = newEClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.CREATE__ECLASS, oldEClass, eClass));
	}
	...
	public Variable getReturn() {
		if (return_ != null && return_.eIsProxy()) {
			...
			if (return_ != oldReturn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.CREATE__RETURN, oldReturn, return_));
			}
		}
		return return_;
	}
	...
	public void setReturn(Variable newReturn) {
		...
		return_ = newReturn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.CREATE__RETURN, oldReturn, return_));
	}
	...
	public EObject getAnchor() {
		if (anchor != null && anchor.eIsProxy()) {
			...
			if (anchor != oldAnchor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.CREATE__ANCHOR, oldAnchor, anchor));
			}
		}
		return anchor;
	}
	...
	public void setAnchor(EObject newAnchor) {
		...
		anchor = newAnchor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.CREATE__ANCHOR, oldAnchor, anchor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcorePackage.CREATE__ECLASS:
				if (resolve) return getEClass();
				return basicGetEClass();
			case WcorePackage.CREATE__RETURN:
				if (resolve) return getReturn();
				return basicGetReturn();
			case WcorePackage.CREATE__ANCHOR:
