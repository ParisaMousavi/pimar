 ...
 * <ul>
 *   <li>{@link gcore.impl.StyleMenuSettingsImpl#getMenuStyle <em>Menu Style</em>}</li>
 *   <li>{@link gcore.impl.StyleMenuSettingsImpl#isFixedMenu <em>Fixed Menu</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StyleMenuSettingsImpl extends MinimalEObjectImpl.Container implements StyleMenuSettings {
	...
	protected EClass eStaticClass() {
		return GcorePackage.Literals.STYLE_MENU_SETTINGS;
	}
	...
	public void setMenuStyle(MenuStyle newMenuStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcorePackage.STYLE_MENU_SETTINGS__MENU_STYLE, oldMenuStyle, menuStyle));
	}
	...
	public void setFixedMenu(boolean newFixedMenu) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcorePackage.STYLE_MENU_SETTINGS__FIXED_MENU, oldFixedMenu, fixedMenu));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcorePackage.STYLE_MENU_SETTINGS__MENU_STYLE:
				return getMenuStyle();
			case GcorePackage.STYLE_MENU_SETTINGS__FIXED_MENU:
				return isFixedMenu();
		}
