 ...
 * <ul>
 *   <li>{@link wcoreDatabase.impl.DeleteImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeleteImpl extends TaskImpl implements Delete {
	...
	protected EClass eStaticClass() {
		return WcoreDatabasePackage.Literals.DELETE;
	}
		...
		if (object != null && object.eIsProxy()) {
			...
			if (object != oldObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcoreDatabasePackage.DELETE__OBJECT, oldObject, object));
			}
		}
		return object;
	}
	...
	public void setObject(Variable newObject) {
		...
		object = newObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.DELETE__OBJECT, oldObject, object));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcoreDatabasePackage.DELETE__OBJECT:
