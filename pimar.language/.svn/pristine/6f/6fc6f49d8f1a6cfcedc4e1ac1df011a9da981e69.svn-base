 ...
 * <ul>
 *   <li>{@link gcore.StyleSelectionSettings#getSelectionColor <em>Selection Color</em>}</li>
 * </ul>
 * </p>
 *
 * @see gcore.GcorePackage#getStyleSelectionSettings()
 * @model
 * @generated
 */
public interface StyleSelectionSettings extends EObject {
	 ...
	 * @see gcore.GcorePackage#getStyleSelectionSettings_SelectionColor()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gcore.StyleSelectionSettings#getSelectionColor <em>Selection Color</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
