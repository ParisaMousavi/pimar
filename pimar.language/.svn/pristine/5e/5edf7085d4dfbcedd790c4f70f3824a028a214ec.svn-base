 ...
 * <ul>
 *   <li>{@link gcoreDatabase.impl.ViewPageImpl#getMenu <em>Menu</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ViewPageImpl extends PageImpl implements ViewPage {
	...
	protected EClass eStaticClass() {
		return GcoreDatabasePackage.Literals.VIEW_PAGE;
	}
		...
		if (menu != null && menu.eIsProxy()) {
			...
			if (menu != oldMenu) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcoreDatabasePackage.VIEW_PAGE__MENU, oldMenu, menu));
			}
		}
		return menu;
	}
	...
	public void setMenu(Menu newMenu) {
		...
		menu = newMenu;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.VIEW_PAGE__MENU, oldMenu, menu));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcoreDatabasePackage.VIEW_PAGE__MENU:
