 ...
 * <ul>
 *   <li>{@link wcore.impl.CrudGuiImpl#getContain <em>Contain</em>}</li>
 *   <li>{@link wcore.impl.CrudGuiImpl#getPrivileges <em>Privileges</em>}</li>
 *   <li>{@link wcore.impl.CrudGuiImpl#getAnchor <em>Anchor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CrudGuiImpl extends TaskImpl implements CrudGui {
	...
	protected EClass eStaticClass() {
		return WcorePackage.Literals.CRUD_GUI;
	}
		...
		if (contain != null && contain.eIsProxy()) {
			...
			if (contain != oldContain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.CRUD_GUI__CONTAIN, oldContain, contain));
			}
		}
		return contain;
	}
	...
	public void setContain(EClass newContain) {
		...
		contain = newContain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.CRUD_GUI__CONTAIN, oldContain, contain));
	}
	...
	public void setPrivileges(Privileges newPrivileges) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.CRUD_GUI__PRIVILEGES, oldPrivileges, privileges));
	}
	...
	public EObject getAnchor() {
		if (anchor != null && anchor.eIsProxy()) {
			...
			if (anchor != oldAnchor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.CRUD_GUI__ANCHOR, oldAnchor, anchor));
			}
		}
		return anchor;
	}
	...
	public void setAnchor(EObject newAnchor) {
		...
		anchor = newAnchor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.CRUD_GUI__ANCHOR, oldAnchor, anchor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcorePackage.CRUD_GUI__CONTAIN:
				if (resolve) return getContain();
				return basicGetContain();
			case WcorePackage.CRUD_GUI__PRIVILEGES:
				return getPrivileges();
			case WcorePackage.CRUD_GUI__ANCHOR:
