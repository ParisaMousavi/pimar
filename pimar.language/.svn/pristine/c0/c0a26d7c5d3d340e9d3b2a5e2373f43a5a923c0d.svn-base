 ...
 * <ul>
 *   <li>{@link wcoreDatabase.impl.InvokeGUIImpl#getOutputAction <em>Output Action</em>}</li>
 *   <li>{@link wcoreDatabase.impl.InvokeGUIImpl#getOutputData <em>Output Data</em>}</li>
 *   <li>{@link wcoreDatabase.impl.InvokeGUIImpl#getInput <em>Input</em>}</li>
 *   <li>{@link wcoreDatabase.impl.InvokeGUIImpl#getPage <em>Page</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InvokeGUIImpl extends TaskImpl implements InvokeGUI {
	...
	protected EClass eStaticClass() {
		return WcoreDatabasePackage.Literals.INVOKE_GUI;
	}
	...
	public EList<Variable> getOutputAction() {
		if (outputAction == null) {
			outputAction = new EObjectResolvingEList<Variable>(Variable.class, this, WcoreDatabasePackage.INVOKE_GUI__OUTPUT_ACTION);
		}
		return outputAction;
	}
	...
	public EList<Variable> getOutputData() {
		if (outputData == null) {
			outputData = new EObjectResolvingEList<Variable>(Variable.class, this, WcoreDatabasePackage.INVOKE_GUI__OUTPUT_DATA);
		}
		return outputData;
	}
	...
	public EList<Variable> getInput() {
		if (input == null) {
			input = new EObjectResolvingEList<Variable>(Variable.class, this, WcoreDatabasePackage.INVOKE_GUI__INPUT);
		}
		return input;
	}
		...
		if (page != null && page.eIsProxy()) {
			...
			if (page != oldPage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcoreDatabasePackage.INVOKE_GUI__PAGE, oldPage, page));
			}
		}
		return page;
	}
	...
	public void setPage(Page newPage) {
		...
		page = newPage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.INVOKE_GUI__PAGE, oldPage, page));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcoreDatabasePackage.INVOKE_GUI__OUTPUT_ACTION:
				return getOutputAction();
			case WcoreDatabasePackage.INVOKE_GUI__OUTPUT_DATA:
				return getOutputData();
			case WcoreDatabasePackage.INVOKE_GUI__INPUT:
				return getInput();
			case WcoreDatabasePackage.INVOKE_GUI__PAGE:
