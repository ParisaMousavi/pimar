 ...
 * <ul>
 *   <li>{@link gcoreDatabase.impl.PageImpl#getPageStyle <em>Page Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PageImpl extends ENamedElementImpl implements Page {
	...
	protected EClass eStaticClass() {
		return GcoreDatabasePackage.Literals.PAGE;
	}
		...
		if (pageStyle != null && pageStyle.eIsProxy()) {
			...
			if (pageStyle != oldPageStyle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcoreDatabasePackage.PAGE__PAGE_STYLE, oldPageStyle, pageStyle));
			}
		}
		return pageStyle;
	}
	...
	public void setPageStyle(StylePageSettings newPageStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.PAGE__PAGE_STYLE, oldPageStyle, pageStyle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcoreDatabasePackage.PAGE__PAGE_STYLE:
