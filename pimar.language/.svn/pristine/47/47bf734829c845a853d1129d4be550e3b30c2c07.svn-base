 ...
 * <ul>
 *   <li>{@link wcore.ProcessSelector#getPage <em>Page</em>}</li>
 *   <li>{@link wcore.ProcessSelector#getProcesses <em>Processes</em>}</li>
 * </ul>
 * </p>
 *
 * @see wcore.WcorePackage#getProcessSelector()
...
public interface ProcessSelector extends Task {
	 ...
	 * @see #setPage(Page)
	 * @see wcore.WcorePackage#getProcessSelector_Page()
	 * @model required="true"
	 * @generated
	 */
	Page getPage();
	...
	/**
	 * Sets the value of the '{@link wcore.ProcessSelector#getPage <em>Page</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link wcore.Process}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see wcore.WcorePackage#getProcessSelector_Processes()
	 * @model required="true"
	 * @generated
	 */
	EList<wcore.Process> getProcesses();
