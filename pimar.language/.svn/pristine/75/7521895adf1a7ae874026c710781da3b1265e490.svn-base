 ...
 * @generated
 */
public class WcoreValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final WcoreValidator INSTANCE = new WcoreValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "wcore";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case WcorePackage.PROCESS:
				return validateProcess((wcore.Process)value, diagnostics, context);
	...
	public boolean validateProcessContainer_oneMainProcess(ProcessContainer processContainer, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(WcorePackage.Literals.PROCESS_CONTAINER,
				 processContainer,
				 diagnostics,
				 context,
	 ...
	 * @generated
	 */
	public boolean validateProcess(wcore.Process process, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateProcess_oneProcessSelectorInMainProcess(wcore.Process process, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(WcorePackage.Literals.PROCESS,
				 process,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
	...
	public boolean validateInvokeProcess_conformingArgumentsToParameters(InvokeProcess invokeProcess, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(WcorePackage.Literals.INVOKE_PROCESS,
				 invokeProcess,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__MAP_PAGE_OUTPUT__EEXPRESSION = "self.page.oclIsTypeOf(gcore::MapPage) implies self.outputData -> size() = 2 and self.outputData -> forAll(var:Variable|var.eType=ecore::EDouble)";
	...
	public boolean validateInvokeGUI_MapPageOutput(InvokeGUI invokeGUI, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(WcorePackage.Literals.INVOKE_GUI,
				 invokeGUI,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__LOGIN_PAGE_OUTPUT__EEXPRESSION = "self.page.oclIsTypeOf(gcore::LoginPage) implies self.outputData -> size() = 1 and self.outputData -> forAll(var:Variable|var.eType=ecore::EBoolean)";
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__LOGIN_PAGE_INPUT__EEXPRESSION = "self.page.oclIsTypeOf(gcore::LoginPage) implies self.input -> size() = 2 and self.input -> forAll(var:Variable|var.eType=ecore::EString)";
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__VIEW_PAGE_OUTPUT__EEXPRESSION = "self.page.oclIsTypeOf(gcore::ViewPage) implies self.outputData -> size() = 1 and self.outputData -> forAll(var:Variable|var.eType.oclIsKindOf(ecore::EObject))";
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__EDIT_PAGE__EEXPRESSION = "self.page.oclIsTypeOf(gcore::EditPage) implies self.outputData -> size() = 1 and self.input -> size() = 1 and self.input -> forAll(var:Variable|var.eType=self.outputData -> at(1).eType)";
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__SELECTABLE_LIST_PAGE_OUTPUT__EEXPRESSION = "self.page.oclIsTypeOf(gcore::SelectableListPage) or self.page.oclIsTypeOf(gcore::ListPage) implies self.outputData -> size() = 1 and self.outputData -> forAll(var:Variable|var.upperBound=-1)";
	 ...
	 * @generated
	 */
	protected static final String INVOKE_GUI__SELECTABLE_PAGE_INPUT__EEXPRESSION = "self.page.oclIsTypeOf(gcore::SelectableListPage) implies self.input -> size() = 1 and self.input -> forAll(var:Variable|var.eType=self.outputData -> at(1).eType and var.upperBound=1)";
	...
	public boolean validateProcessSelector_oneGUITaskInAllSubProcesses(ProcessSelector processSelector, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(WcorePackage.Literals.PROCESS_SELECTOR,
				 processSelector,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
