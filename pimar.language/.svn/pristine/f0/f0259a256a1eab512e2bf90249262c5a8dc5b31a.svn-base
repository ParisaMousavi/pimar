 ...
 * <ul>
 *   <li>{@link wcore.InvokeProcess#getSubProcess <em>Sub Process</em>}</li>
 *   <li>{@link wcore.InvokeProcess#getArguments <em>Arguments</em>}</li>
 *   <li>{@link wcore.InvokeProcess#getReturn <em>Return</em>}</li>
 *   <li>{@link wcore.InvokeProcess#isSynchronized <em>Synchronized</em>}</li>
 * </ul>
 * </p>
 *
 * @see wcore.WcorePackage#getInvokeProcess()
...
public interface InvokeProcess extends Task {
	 ...
	 * @see #setSubProcess(wcore.Process)
	 * @see wcore.WcorePackage#getInvokeProcess_SubProcess()
	 * @model required="true"
	 * @generated
	 */
	wcore.Process getSubProcess();

	/**
	 * Sets the value of the '{@link wcore.InvokeProcess#getSubProcess <em>Sub Process</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setSubProcess(wcore.Process value);
	 ...
	 * @see wcore.WcorePackage#getInvokeProcess_Arguments()
	 * @model
	 * @generated
	 */
	 ...
	 * @see wcore.WcorePackage#getInvokeProcess_Return()
	 * @model
	 * @generated
	 */
	 ...
	 * @see wcore.WcorePackage#getInvokeProcess_Synchronized()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link wcore.InvokeProcess#isSynchronized <em>Synchronized</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
