 ...
 * <ul>
 *   <li>{@link wcoreDatabase.TerminalExpression#getRefers <em>Refers</em>}</li>
 * </ul>
 * </p>
 *
 * @see wcoreDatabase.WcoreDatabasePackage#getTerminalExpression()
 * @model
 * @generated
 */
public interface TerminalExpression extends Expression {
	 ...
	 * @see wcoreDatabase.WcoreDatabasePackage#getTerminalExpression_Refers()
	 * @model required="true"
	 * @generated
	 */
	Variable getRefers();
	...
	/**
	 * Sets the value of the '{@link wcoreDatabase.TerminalExpression#getRefers <em>Refers</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
