 ...
 * <ul>
 *   <li>{@link wcoreDatabase.Process#getVariables <em>Variables</em>}</li>
 *   <li>{@link wcoreDatabase.Process#getStartTask <em>Start Task</em>}</li>
 *   <li>{@link wcoreDatabase.Process#getReturn <em>Return</em>}</li>
 * </ul>
 * </p>
 *
 * @see wcoreDatabase.WcoreDatabasePackage#getProcess()
...
public interface Process extends ENamedElement {
	 ...
	 * @see wcoreDatabase.WcoreDatabasePackage#getProcess_Variables()
	 ...
	 * @see wcoreDatabase.WcoreDatabasePackage#getProcess_StartTask()
	...
	/**
	 * Sets the value of the '{@link wcoreDatabase.Process#getStartTask <em>Start Task</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see wcoreDatabase.WcoreDatabasePackage#getProcess_Return()
	 * @model containment="true"
	 * @generated
	 */
