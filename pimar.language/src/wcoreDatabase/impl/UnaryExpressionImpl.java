 ...
 * <ul>
 *   <li>{@link wcoreDatabase.impl.UnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link wcoreDatabase.impl.UnaryExpressionImpl#getRightExpression <em>Right Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnaryExpressionImpl extends ExpressionImpl implements UnaryExpression {
	...
	protected EClass eStaticClass() {
		return WcoreDatabasePackage.Literals.UNARY_EXPRESSION;
	}
	...
	public void setOperator(UnaryOperators newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.UNARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain basicSetRightExpression(Expression newRightExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.UNARY_EXPRESSION__RIGHT_EXPRESSION, oldRightExpression, newRightExpression);
	...
	public void setRightExpression(Expression newRightExpression) {
		if (newRightExpression != rightExpression) {
			...
			if (rightExpression != null)
				msgs = ((InternalEObject)rightExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.UNARY_EXPRESSION__RIGHT_EXPRESSION, null, msgs);
			if (newRightExpression != null)
				msgs = ((InternalEObject)newRightExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.UNARY_EXPRESSION__RIGHT_EXPRESSION, null, msgs);
			msgs = basicSetRightExpression(newRightExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.UNARY_EXPRESSION__RIGHT_EXPRESSION, newRightExpression, newRightExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WcoreDatabasePackage.UNARY_EXPRESSION__RIGHT_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcoreDatabasePackage.UNARY_EXPRESSION__OPERATOR:
				return getOperator();
			case WcoreDatabasePackage.UNARY_EXPRESSION__RIGHT_EXPRESSION:
