 ...
 * <ul>
 *   <li>{@link wcoreDatabase.impl.ReadImpl#getObject <em>Object</em>}</li>
 *   <li>{@link wcoreDatabase.impl.ReadImpl#getReturn <em>Return</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadImpl extends TaskImpl implements Read {
	...
	protected EClass eStaticClass() {
		return WcoreDatabasePackage.Literals.READ;
	}
		...
		if (object != null && object.eIsProxy()) {
			...
			if (object != oldObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcoreDatabasePackage.READ__OBJECT, oldObject, object));
			}
		}
		return object;
	}
	...
	public void setObject(Variable newObject) {
		...
		object = newObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.READ__OBJECT, oldObject, object));
	}
	...
	public Variable getReturn() {
		if (return_ != null && return_.eIsProxy()) {
			...
			if (return_ != oldReturn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcoreDatabasePackage.READ__RETURN, oldReturn, return_));
			}
		}
		return return_;
	}
	...
	public void setReturn(Variable newReturn) {
		...
		return_ = newReturn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.READ__RETURN, oldReturn, return_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcoreDatabasePackage.READ__OBJECT:
				if (resolve) return getObject();
				return basicGetObject();
			case WcoreDatabasePackage.READ__RETURN:
