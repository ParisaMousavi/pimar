 ...
 * <ul>
 *   <li>{@link wcoreDatabase.impl.IfElseImpl#getElseBody <em>Else Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfElseImpl extends IfImpl implements IfElse {
	...
	protected EClass eStaticClass() {
		return WcoreDatabasePackage.Literals.IF_ELSE;
	}
	...
	public NotificationChain basicSetElseBody(Task newElseBody, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.IF_ELSE__ELSE_BODY, oldElseBody, newElseBody);
	...
	public void setElseBody(Task newElseBody) {
		if (newElseBody != elseBody) {
			...
			if (elseBody != null)
				msgs = ((InternalEObject)elseBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.IF_ELSE__ELSE_BODY, null, msgs);
			if (newElseBody != null)
				msgs = ((InternalEObject)newElseBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WcoreDatabasePackage.IF_ELSE__ELSE_BODY, null, msgs);
			msgs = basicSetElseBody(newElseBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcoreDatabasePackage.IF_ELSE__ELSE_BODY, newElseBody, newElseBody));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WcoreDatabasePackage.IF_ELSE__ELSE_BODY:
