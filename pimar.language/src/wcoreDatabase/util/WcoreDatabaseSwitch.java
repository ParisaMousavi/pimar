 ...
 * @generated
 */
public class WcoreDatabaseSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WcoreDatabasePackage.PROCESS: {
				wcoreDatabase.Process process = (wcoreDatabase.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(wcoreDatabase.Process object) {
		return null;
	}
