 ...
 * <ul>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getRgbColors <em>Rgb Colors</em>}</li>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getMenuStyle <em>Menu Style</em>}</li>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getSelectionStyle <em>Selection Style</em>}</li>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getPageStyle <em>Page Style</em>}</li>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getFontColor <em>Font Color</em>}</li>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getBackColor <em>Back Color</em>}</li>
 *   <li>{@link gcoreDatabase.impl.StyleSettingImpl#getListStyle <em>List Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StyleSettingImpl extends MinimalEObjectImpl.Container implements StyleSetting {
	...
	protected EClass eStaticClass() {
		return GcoreDatabasePackage.Literals.STYLE_SETTING;
	}
	...
	public EList<RGBColor> getRgbColors() {
		if (rgbColors == null) {
			rgbColors = new EObjectContainmentEList<RGBColor>(RGBColor.class, this, GcoreDatabasePackage.STYLE_SETTING__RGB_COLORS);
		}
		return rgbColors;
	}
	...
	public NotificationChain basicSetMenuStyle(StyleMenuSettings newMenuStyle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__MENU_STYLE, oldMenuStyle, newMenuStyle);
	...
	public void setMenuStyle(StyleMenuSettings newMenuStyle) {
		if (newMenuStyle != menuStyle) {
			...
			if (menuStyle != null)
				msgs = ((InternalEObject)menuStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__MENU_STYLE, null, msgs);
			if (newMenuStyle != null)
				msgs = ((InternalEObject)newMenuStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__MENU_STYLE, null, msgs);
			msgs = basicSetMenuStyle(newMenuStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__MENU_STYLE, newMenuStyle, newMenuStyle));
	}
	...
	public NotificationChain basicSetSelectionStyle(StyleSelectionSettings newSelectionStyle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__SELECTION_STYLE, oldSelectionStyle, newSelectionStyle);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSelectionStyle(StyleSelectionSettings newSelectionStyle) {
		if (newSelectionStyle != selectionStyle) {
			...
			if (selectionStyle != null)
				msgs = ((InternalEObject)selectionStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__SELECTION_STYLE, null, msgs);
			if (newSelectionStyle != null)
				msgs = ((InternalEObject)newSelectionStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__SELECTION_STYLE, null, msgs);
			msgs = basicSetSelectionStyle(newSelectionStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__SELECTION_STYLE, newSelectionStyle, newSelectionStyle));
	}
	...
	public NotificationChain basicSetPageStyle(StylePageSettings newPageStyle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__PAGE_STYLE, oldPageStyle, newPageStyle);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPageStyle(StylePageSettings newPageStyle) {
		if (newPageStyle != pageStyle) {
			NotificationChain msgs = null;
			if (pageStyle != null)
				msgs = ((InternalEObject)pageStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__PAGE_STYLE, null, msgs);
			if (newPageStyle != null)
				msgs = ((InternalEObject)newPageStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__PAGE_STYLE, null, msgs);
			msgs = basicSetPageStyle(newPageStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__PAGE_STYLE, newPageStyle, newPageStyle));
	}
	...
	public RGBColor getFontColor() {
		if (fontColor != null && fontColor.eIsProxy()) {
			...
			if (fontColor != oldFontColor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcoreDatabasePackage.STYLE_SETTING__FONT_COLOR, oldFontColor, fontColor));
			}
		}
		return fontColor;
	}
	...
	public void setFontColor(RGBColor newFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__FONT_COLOR, oldFontColor, fontColor));
	}
	...
	public RGBColor getBackColor() {
		if (backColor != null && backColor.eIsProxy()) {
			...
			if (backColor != oldBackColor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcoreDatabasePackage.STYLE_SETTING__BACK_COLOR, oldBackColor, backColor));
			}
		}
		return backColor;
	}
	...
	public void setBackColor(RGBColor newBackColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__BACK_COLOR, oldBackColor, backColor));
	}
	...
	public NotificationChain basicSetListStyle(StyleListSettings newListStyle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__LIST_STYLE, oldListStyle, newListStyle);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setListStyle(StyleListSettings newListStyle) {
		if (newListStyle != listStyle) {
			NotificationChain msgs = null;
			if (listStyle != null)
				msgs = ((InternalEObject)listStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__LIST_STYLE, null, msgs);
			if (newListStyle != null)
				msgs = ((InternalEObject)newListStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GcoreDatabasePackage.STYLE_SETTING__LIST_STYLE, null, msgs);
			msgs = basicSetListStyle(newListStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SETTING__LIST_STYLE, newListStyle, newListStyle));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GcoreDatabasePackage.STYLE_SETTING__RGB_COLORS:
				return ((InternalEList<?>)getRgbColors()).basicRemove(otherEnd, msgs);
			case GcoreDatabasePackage.STYLE_SETTING__MENU_STYLE:
				return basicSetMenuStyle(null, msgs);
			case GcoreDatabasePackage.STYLE_SETTING__SELECTION_STYLE:
				return basicSetSelectionStyle(null, msgs);
			case GcoreDatabasePackage.STYLE_SETTING__PAGE_STYLE:
				return basicSetPageStyle(null, msgs);
			case GcoreDatabasePackage.STYLE_SETTING__LIST_STYLE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GcoreDatabasePackage.STYLE_SETTING__PAGE_STYLE:
				return getPageStyle();
			case GcoreDatabasePackage.STYLE_SETTING__FONT_COLOR:
				if (resolve) return getFontColor();
				return basicGetFontColor();
			case GcoreDatabasePackage.STYLE_SETTING__BACK_COLOR:
