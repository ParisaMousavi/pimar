 ...
 * <ul>
 *   <li>{@link gcoreDatabase.impl.StyleSelectionSettingsImpl#getSelectionColor <em>Selection Color</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StyleSelectionSettingsImpl extends MinimalEObjectImpl.Container implements StyleSelectionSettings {
	...
	protected EClass eStaticClass() {
		return GcoreDatabasePackage.Literals.STYLE_SELECTION_SETTINGS;
	}
		...
		if (selectionColor != null && selectionColor.eIsProxy()) {
			...
			if (selectionColor != oldSelectionColor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcoreDatabasePackage.STYLE_SELECTION_SETTINGS__SELECTION_COLOR, oldSelectionColor, selectionColor));
			}
		}
	...
	public void setSelectionColor(RGBColor newSelectionColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.STYLE_SELECTION_SETTINGS__SELECTION_COLOR, oldSelectionColor, selectionColor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcoreDatabasePackage.STYLE_SELECTION_SETTINGS__SELECTION_COLOR:
