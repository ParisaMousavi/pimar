 ...
 * <ul>
 *   <li>{@link gcoreDatabase.impl.MenuImpl#getMenuStyle <em>Menu Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MenuImpl extends ENamedElementImpl implements Menu {
	...
	protected EClass eStaticClass() {
		return GcoreDatabasePackage.Literals.MENU;
	}
		...
		if (menuStyle != null && menuStyle.eIsProxy()) {
			...
			if (menuStyle != oldMenuStyle) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcoreDatabasePackage.MENU__MENU_STYLE, oldMenuStyle, menuStyle));
			}
		}
		return menuStyle;
	}
	...
	public void setMenuStyle(StyleMenuSettings newMenuStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcoreDatabasePackage.MENU__MENU_STYLE, oldMenuStyle, menuStyle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcoreDatabasePackage.MENU__MENU_STYLE:
