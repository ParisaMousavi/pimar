...
import gcore.util.GcoreValidator;
...
public class GcorePackageImpl extends EPackageImpl implements GcorePackage {
	 ...
	 * @see gcore.GcorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
			...
			(theGcorePackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return GcoreValidator.INSTANCE;
				 }
			 });
	 ...
	 * @generated
	 */
	public EReference getListablePage_ListablepageStyle() {
		return (EReference)listablePageEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getSelectablePage_SelectablepageStyle() {
		return (EReference)selectablePageEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMenuablePage_Menu() {
		return (EReference)menuablePageEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(listablePageEClass, LISTABLE_PAGE__LISTABLEPAGE_STYLE);

		selectablePageEClass = createEClass(SELECTABLE_PAGE);
		createEAttribute(selectablePageEClass, SELECTABLE_PAGE__MULTI_SELECTION);
		createEReference(selectablePageEClass, SELECTABLE_PAGE__SELECTABLEPAGE_STYLE);

		menuablePageEClass = createEClass(MENUABLE_PAGE);
		createEReference(menuablePageEClass, MENUABLE_PAGE__MENU);
	...
	public void initializePackageContents() {
		...
		initEReference(getListablePage_ListablepageStyle(), this.getStyleListSettings(), null, "listablepageStyle", null, 1, 1, ListablePage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSelectablePage_SelectablepageStyle(), this.getStyleSelectionSettings(), null, "selectablepageStyle", null, 1, 1, SelectablePage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(menuablePageEClass, MenuablePage.class, "MenuablePage", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMenuablePage_Menu(), this.getMenu(), null, "menu", null, 0, 1, MenuablePage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
