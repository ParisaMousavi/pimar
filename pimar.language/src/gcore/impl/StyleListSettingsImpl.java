 ...
 * <ul>
 *   <li>{@link gcore.impl.StyleListSettingsImpl#isSeparatorShow <em>Separator Show</em>}</li>
 *   <li>{@link gcore.impl.StyleListSettingsImpl#getListStyle <em>List Style</em>}</li>
 *   <li>{@link gcore.impl.StyleListSettingsImpl#getSeparatorColor <em>Separator Color</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StyleListSettingsImpl extends MinimalEObjectImpl.Container implements StyleListSettings {
	...
	protected EClass eStaticClass() {
		return GcorePackage.Literals.STYLE_LIST_SETTINGS;
	}
	...
	public void setSeparatorShow(boolean newSeparatorShow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcorePackage.STYLE_LIST_SETTINGS__SEPARATOR_SHOW, oldSeparatorShow, separatorShow));
	}
	...
	public void setListStyle(ListStyle newListStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcorePackage.STYLE_LIST_SETTINGS__LIST_STYLE, oldListStyle, listStyle));
	}
	...
	public RGBColor getSeparatorColor() {
		if (separatorColor != null && separatorColor.eIsProxy()) {
			...
			if (separatorColor != oldSeparatorColor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcorePackage.STYLE_LIST_SETTINGS__SEPARATOR_COLOR, oldSeparatorColor, separatorColor));
			}
		}
	...
	public void setSeparatorColor(RGBColor newSeparatorColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcorePackage.STYLE_LIST_SETTINGS__SEPARATOR_COLOR, oldSeparatorColor, separatorColor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcorePackage.STYLE_LIST_SETTINGS__SEPARATOR_SHOW:
				return isSeparatorShow();
			case GcorePackage.STYLE_LIST_SETTINGS__LIST_STYLE:
				return getListStyle();
			case GcorePackage.STYLE_LIST_SETTINGS__SEPARATOR_COLOR:
