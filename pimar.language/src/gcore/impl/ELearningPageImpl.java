 ...
 * <ul>
 *   <li>{@link gcore.impl.ELearningPageImpl#getMenu <em>Menu</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ELearningPageImpl extends PageImpl implements ELearningPage {
	...
	protected EClass eStaticClass() {
		return GcorePackage.Literals.ELEARNING_PAGE;
	}
		...
		if (menu != null && menu.eIsProxy()) {
			...
			if (menu != oldMenu) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GcorePackage.ELEARNING_PAGE__MENU, oldMenu, menu));
			}
		}
		return menu;
	}
	...
	public void setMenu(Menu newMenu) {
		...
		menu = newMenu;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GcorePackage.ELEARNING_PAGE__MENU, oldMenu, menu));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GcorePackage.ELEARNING_PAGE__MENU:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MenuablePage.class) {
			switch (derivedFeatureID) {
				case GcorePackage.ELEARNING_PAGE__MENU: return GcorePackage.MENUABLE_PAGE__MENU;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MenuablePage.class) {
			switch (baseFeatureID) {
				case GcorePackage.MENUABLE_PAGE__MENU: return GcorePackage.ELEARNING_PAGE__MENU;
				default: return -1;
			}
		}
