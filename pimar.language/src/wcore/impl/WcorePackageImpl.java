...
import wcore.util.WcoreValidator;
 ...
 * @generated
 */
public class WcorePackageImpl extends EPackageImpl implements WcorePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see wcore.WcorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private WcorePackageImpl() {
		super(eNS_URI, WcoreFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link WcorePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static WcorePackage init() {
		if (isInited) return (WcorePackage)EPackage.Registry.INSTANCE.getEPackage(WcorePackage.eNS_URI);

		// Obtain or create and register package
		WcorePackageImpl theWcorePackage = (WcorePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof WcorePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new WcorePackageImpl());
		...
		theWcorePackage.createPackageContents();

		// Initialize created meta-data
		theWcorePackage.initializePackageContents();
			...
			(theWcorePackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return WcoreValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theWcorePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(WcorePackage.eNS_URI, theWcorePackage);
		return theWcorePackage;
	}
	 ...
	 * @generated
	 */
	public WcoreFactory getWcoreFactory() {
		return (WcoreFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEClass(processEClass, wcore.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getProcess_Variables(), this.getVariable(), null, "variables", null, 0, -1, wcore.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_StartTask(), this.getTask(), null, "startTask", null, 1, 1, wcore.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_Return(), this.getVariable(), null, "return", null, 0, -1, wcore.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInvokeGUI_Page(), theGcorePackage.getPage(), null, "page", null, 1, 1, InvokeGUI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProcessSelector_Page(), theGcorePackage.getPage(), null, "page", null, 1, 1, ProcessSelector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createOCLAnnotations() {
		...
		addAnnotation
		  (invokeGUIEClass, 
		   source, 
		   new String[] {
			 "MapPageOutput", "self.page.oclIsTypeOf(gcore::MapPage) implies self.outputData -> size() = 2 and self.outputData -> forAll(var:Variable|var.eType=ecore::EDouble)",
			 "LoginPageOutput", "self.page.oclIsTypeOf(gcore::LoginPage) implies self.outputData -> size() = 1 and self.outputData -> forAll(var:Variable|var.eType=ecore::EBoolean)",
			 "LoginPageInput", "self.page.oclIsTypeOf(gcore::LoginPage) implies self.input -> size() = 2 and self.input -> forAll(var:Variable|var.eType=ecore::EString)",
			 "ViewPageOutput", "self.page.oclIsTypeOf(gcore::ViewPage) implies self.outputData -> size() = 1 and self.outputData -> forAll(var:Variable|var.eType.oclIsKindOf(ecore::EObject))",
			 "EditPage", "self.page.oclIsTypeOf(gcore::EditPage) implies self.outputData -> size() = 1 and self.input -> size() = 1 and self.input -> forAll(var:Variable|var.eType=self.outputData -> at(1).eType)",
			 "SelectableListPageOutput", "self.page.oclIsTypeOf(gcore::SelectableListPage) or self.page.oclIsTypeOf(gcore::ListPage) implies self.outputData -> size() = 1 and self.outputData -> forAll(var:Variable|var.upperBound=-1)",
			 "SelectablePageInput", "self.page.oclIsTypeOf(gcore::SelectableListPage) implies self.input -> size() = 1 and self.input -> forAll(var:Variable|var.eType=self.outputData -> at(1).eType and var.upperBound=1)"
		   });			
		addAnnotation
		  (processSelectorEClass, 
		   source, 
