 ...
 * <ul>
 *   <li>{@link wcore.impl.InvokeOperationImpl#getContext <em>Context</em>}</li>
 *   <li>{@link wcore.impl.InvokeOperationImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link wcore.impl.InvokeOperationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link wcore.impl.InvokeOperationImpl#getReturn <em>Return</em>}</li>
 *   <li>{@link wcore.impl.InvokeOperationImpl#isLong <em>Long</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InvokeOperationImpl extends TaskImpl implements InvokeOperation {
	...
	protected EClass eStaticClass() {
		return WcorePackage.Literals.INVOKE_OPERATION;
	}
		...
		if (context != null && context.eIsProxy()) {
			...
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.INVOKE_OPERATION__CONTEXT, oldContext, context));
			}
		}
		return context;
	}
	...
	public void setContext(Variable newContext) {
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.INVOKE_OPERATION__CONTEXT, oldContext, context));
	}
	...
	public EOperation getOperation() {
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.INVOKE_OPERATION__OPERATION, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(EOperation newOperation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.INVOKE_OPERATION__OPERATION, oldOperation, operation));
	}
	...
	public EList<Variable> getArguments() {
		if (arguments == null) {
			arguments = new EObjectResolvingEList<Variable>(Variable.class, this, WcorePackage.INVOKE_OPERATION__ARGUMENTS);
		}
		return arguments;
	}
	...
	public Variable getReturn() {
		if (return_ != null && return_.eIsProxy()) {
			...
			if (return_ != oldReturn) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WcorePackage.INVOKE_OPERATION__RETURN, oldReturn, return_));
			}
		}
		return return_;
	}
	...
	public void setReturn(Variable newReturn) {
		...
		return_ = newReturn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.INVOKE_OPERATION__RETURN, oldReturn, return_));
	}
	...
	public void setLong(boolean newLong) {
		...
		long_ = newLong;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WcorePackage.INVOKE_OPERATION__LONG, oldLong, long_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WcorePackage.INVOKE_OPERATION__CONTEXT:
				if (resolve) return getContext();
				return basicGetContext();
			case WcorePackage.INVOKE_OPERATION__OPERATION:
				if (resolve) return getOperation();
				return basicGetOperation();
			case WcorePackage.INVOKE_OPERATION__ARGUMENTS:
				return getArguments();
			case WcorePackage.INVOKE_OPERATION__RETURN:
				if (resolve) return getReturn();
				return basicGetReturn();
			case WcorePackage.INVOKE_OPERATION__LONG:
				return isLong();
		}
